...
# Generated on: Wed Mar 27 19:48:40 IST 2024 (Wed Mar 27 14:18:40 UTC 2024)
...
set_log_file fv/rca/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/rca -revised fv_map
...
read_library -liberty -both /home/VLSI/HRISHI/PD_LAB/LAB_ASSIGNMENT/SYN/../LIB/slow_vdd1v0_basicCells.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  ../RTL/full_adder.sv ../RTL/d_ff.sv ../RTL/rca.sv
elaborate_design -golden -root {rca} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/rca/fv_map.v.gz
elaborate_design -revised -root {rca}
...
#add_name_alias fv/rca/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/rca/rtl_to_fv_map.log
}
